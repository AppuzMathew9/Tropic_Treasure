...
const PRODUCTS_DB = [
  ...
  },
  {
    ...
    image: "images/cardamom_pouch_new.jpg",
    caption: "Premium Green Cardamom Pods, packed freshly for optimal preservation of essential oils and aroma.",
  ...
  },
  {
    ...
    category: "Dehydrated Ingredients",
    image: "images/ginger_pouch_new.jpg",
  ...
  },
  {
    ...
    image: "images/cashew_pouch_new.jpg",
  ...
  {
    id: "teakwood-grinder",
    name: "Handcrafted Wooden Pepper Grinder",
    scientificName: "Tectona grandis (Teak)",
    origin: "Nilambur, Kerala, India",
    category: "Lifestyle & Craft",
    image: "images/wooden_pepper_grinder.png",
  ...
  },
  {
    ...
    caption: "Finely milled organic Moringa leaves, packed with essential amino acids and vibrant chlorophyll.",
    tagline: "The miracle tree powder, shade-dried for maximum nutrient retention.",
    price: "£14.50",
    unit: "150g Pouch",
    discount: null,
    rating: 4.8,
    ...
    originalPrice: null,
    pdfUrl: null,
    bullets: ["Rich in Iron & Vitamins", "Shade-dried", "100% Organic", "No additives"],
    specs: { "Botanical Name": "Moringa oleifera", "Grade": "Premium Milled" },
    traceabilityCode: "TT-MOR-01",
    sourcingStory: "Sourced from organic certified farms in Palakkad, our moringa is gently shade-dried to protect its delicate nutritional profile.",
    usage: "Blend into smoothies or matcha lattes.",
    packaging: "Resealable UV-protected pouch.",
    shipping: "UK nationwide shipping within 2-3 business days."
  },
  {
    id: "cardamom-oil",
    ...
    origin: "Idukki, Kerala, India",
    category: "Herbal Wellness",
    image: "images/cardamom_oil.png",
    caption: "Pure, steam-distilled cardamom essential oil capturing the sweet, spicy essence of the green pods.",
    tagline: "Therapeutic grade cardamom oil, steam distilled from premium pods.",
    price: "£22.00",
    unit: "10ml Dropper Bottle",
    discount: null,
    rating: 4.9,
    reviewsCount: 15,
    originalPrice: null,
    pdfUrl: null,
    bullets: ["Steam Distilled", "Therapeutic Grade", "100% Pure Extract", "Aromatherapy ready"],
    specs: { "Botanical Name": "Elettaria cardamomum", "Extraction": "Steam Distillation" },
    traceabilityCode: "TT-OIL-02",
    sourcingStory: "Distilled locally in Idukki immediately after harvest to capture the most volatile and delicate aromatic notes.",
    usage: "Dilute with carrier oil for massage or add to a diffuser.",
  ...
  },
  {
    ...
    origin: "Wayanad, Kerala, India",
    category: "Herbal Wellness",
    image: "images/black_pepper_oil.png",
    caption: "Warm, spicy, and invigorating black pepper essential oil.",
    tagline: "Warming and stimulating pure pepper extract.",
    price: "£19.00",
    unit: "10ml Dropper Bottle",
    discount: null,
    rating: 5,
    ...
    originalPrice: null,
    pdfUrl: null,
    bullets: ["Steam Distilled", "Warming properties", "100% Pure Extract", "Rich in piperine"],
    specs: { "Botanical Name": "Piper nigrum", "Extraction": "Steam Distillation" },
    traceabilityCode: "TT-OIL-03",
    sourcingStory: "Extracted from crushed Tellicherry peppercorns using careful steam distillation.",
    usage: "Use in aromatherapy for its warming, stimulating effect.",
    packaging: "Dark violet glass bottle.",
    shipping: "UK nationwide shipping within 2-3 business days."
  },
  {
    id: "wooden-spice-box",
    name: "Wooden Themed Spice Box",
    scientificName: "Rosewood",
    origin: "Kerala, India",
    category: "Lifestyle & Craft",
    image: "images/wooden_spice_box.png",
    caption: "Traditional 'Anjara Petti' spice box handcrafted from premium rosewood with brass fittings.",
    tagline: "The quintessential Kerala kitchen essential.",
    price: "£45.00",
    unit: "1 Box",
    discount: null,
    rating: 4.8,
    ...
    originalPrice: null,
    pdfUrl: null,
    bullets: ["Handcrafted Rosewood", "Brass Hinges", "Multiple compartments", "Heritage Design"],
    specs: { "Material": "Indian Rosewood", "Craft": "Hand-carved" },
    traceabilityCode: "TT-CRF-01",
    sourcingStory: "Made by traditional artisans in Kerala, preserving a craft that has been passed down for generations.",
    usage: "Store your daily spices elegantly on your kitchen counter.",
    packaging: "Protective corrugated box.",
    shipping: "UK nationwide shipping within 2-3 business days."
  },
  {
    id: "aranmula-kannadi",
    name: "Aranmula Kannadi",
    scientificName: "Metal Alloy",
    origin: "Aranmula, Kerala, India",
    category: "Lifestyle & Craft",
    image: "images/aranmula_kannadi.png",
    caption: "A traditional handmade metal-alloy mirror from Aranmula, Kerala, famed for its front-surface reflection.",
    tagline: "A rare, front-reflecting metal mirror handcrafted using secret metallurgical techniques.",
    price: "£120.00",
    unit: "1 Mirror with Stand",
    discount: null,
    rating: 5,
    reviewsCount: 8,
    originalPrice: null,
    pdfUrl: null,
    bullets: ["Authentic Aranmula Craft", "Unique Metal Alloy", "Front-surface reflection", "Geographical Indication (GI) tagged"],
    specs: { "Material": "Secret Copper-Tin Alloy", "Origin": "Aranmula" },
    traceabilityCode: "TT-CRF-02",
    sourcingStory: "Produced exclusively by one extended family in Aranmula. The exact composition of the alloy remains a closely guarded secret.",
    usage: "Use as an auspicious decor piece or an exquisite traditional gift.",
    packaging: "Velvet-lined presentation box.",
    shipping: "Shipped fully insured from London."
  },
  {
    id: "nettipattam",
    name: "Miniature Nettipattam",
    scientificName: "Fabric & Gold-Plated Polymer",
    origin: "Thrissur, Kerala, India",
    category: "Lifestyle & Craft",
    image: "images/nettipattam.png",
    caption: "An ornate miniature version of the traditional Kerala elephant caparison, perfect for wall decoration.",
    tagline: "Bring the grandeur of Kerala's temple festivals into your home.",
    price: "£65.00",
    unit: "1 Wall Hanging",
    discount: null,
    rating: 4.7,
    ...
    originalPrice: null,
    pdfUrl: null,
    bullets: ["Hand-stitched details", "Gold-toned ornaments", "Traditional festival decor", "Wall-hanging ready"],
    specs: { "Material": "Felt and Metallic Polymers", "Craft": "Hand-assembled" },
    traceabilityCode: "TT-CRF-03",
    sourcingStory: "Hand-assembled by craftsmen in Thrissur, mimicking the exact geometric patterns of the full-sized caparisons used during Pooram.",
    usage: "Hang on the wall as a vibrant, cultural statement piece.",
    packaging: "Protective tube or flat box.",
    shipping: "UK nationwide shipping within 2-3 business days."
  }
];
